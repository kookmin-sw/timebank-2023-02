...
--
-- Table structure for table `payapp`
--

DROP TABLE IF EXISTS `payapp`;
...
--
-- Dumping data for table `payapp`
--

LOCK TABLES `payapp` WRITE;
/*!40000 ALTER TABLE `payapp` DISABLE KEYS */;
/*!40000 ALTER TABLE `payapp` ENABLE KEYS */;
UNLOCK TABLES;
